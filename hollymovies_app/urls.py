...
from hollymovies_app.views.movie import MovieDetailView, UpdateMovieView, DeleteMovieView, GenreDetailView, \
...
genre_urlpatterns = ([
    path('genre/<str:genre_name>/', GenreDetailView.as_view(), name='detail'),
], 'genre')
